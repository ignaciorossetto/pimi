...
export default async function CuidadorHomePage() {
  ...
  const [
    ...
    supabase
      ...
      .select(
        "zona, bio, tarifa_base, tipos_de_servicio, verificado, foto, tier, comision_pct, reviews_count, rating_promedio, domicilio_calle, domicilio_numero, domicilio_piso_depto, domicilio_barrio, domicilio_ciudad, tipo_vivienda, tiene_patio, domicilio_lat, domicilio_lng, tiene_mascotas_propias, tamanos_aceptados, especies_aceptadas, etapas_aceptadas, cbu_alias, titular_cuenta",
      )
      .eq("user_id", user.id)
      .maybeSingle(),
    supabase
